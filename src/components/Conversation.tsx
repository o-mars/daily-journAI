        ...
        >
          <div 
            style={{
              ...
              padding: '8px 12px',
              borderRadius: '18px',
              backgroundColor: message.from === 'user' ? 'var(--chat-bubble-user-bg)' : 'var(--chat-bubble-assistant-bg)',
              color: message.from === 'user' ? 'var(--chat-bubble-user)' : 'var(--chat-bubble-assistant)',
              wordWrap: 'break-word',
