...
const DailyClientContext = createContext<DailyClientContextType | null>(null);
...
export const DailyClientProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <DailyClientContext.Provider value={{
      voiceClient,
      isStarted,
      isLoading,
      isMicEnabled,
    ...
    </DailyClientContext.Provider>
  );
};

export const useDailyClient = () => useContext(DailyClientContext);