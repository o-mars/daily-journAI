...
export const DEFAULT_JOURNALING_HUME_CONFIG_ID = '1eb3dbb0-9501-43a7-9079-e9e576185d71';
export const DEFAULT_DATING_HUME_CONFIG_ID = '66ae5bcb-df5d-4784-944b-80063fbfd130';
export const DEFAULT_SOLUTIONS_HUME_CONFIG_ID = 'd74740e0-b8d6-423a-bcb5-15969dec58df';
export const DEFAULT_GRATITUDE_HUME_CONFIG_ID = '27ba85a3-7f60-4746-82e2-8dfb7ba37000';
export const DEFAULT_GROWTH_HUME_CONFIG_ID = '3b57ac5a-945c-4262-a9f1-50fbe0c92a00';
export const DEFAULT_CREATIVITY_HUME_CONFIG_ID = 'eef02d28-cbd1-4af9-a919-4a405b0c3eb0';
