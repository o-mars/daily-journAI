const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-backgroundtext-primary">
      <div className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-8 text-blue-400">Privacy Policy</h1>
        
        <div className="space-y-6 text-tertiary">
          <section className="bg-surface-1 rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4 text-primary">Privacy</h2>
